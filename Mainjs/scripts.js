...
if(validationinput(userName,'firstID')&& validationinput(lastName,'lastnameID')
  && validationinput(emailE,'emailID')&& validationinput(passwordSign,'passID')
...
let password=document.getElementById('loginpassword').value
  if(validationinput(loginemail,'emailID') &&validationinput(loginpassword,'passwordconID') ){
